...
- [フォントの指定方法 > フォントを指定するしくみ](/ja/create-and-save-documents/how-to-specify-fonts.md#フォントを指定するしくみ)
- [Theme（themeの選択）> Custom theme](/ja/functions-of-the-actions-menu/theme.md#custom-theme)）
